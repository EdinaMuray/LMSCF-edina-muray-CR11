...
<?php 
    ...
    if ($_POST) {
        ...
        $sql = "INSERT INTO users (userName, userEmail) VALUES ('$uname', '$uemail','$upass')";

        if($connect->query($sql) === TRUE) {
            echo "<div class='box'><br><h4>New Record Successfully Created</h4></div>";
            echo "<a href='s_create.php'><button type='button' class='btn btn-info'>Back</button></a>";
            echo "<a href='../login/home_super.php'><button type='button' class='btn btn-info'>Home</button></a>";
        }else {
            echo "Error ";
        }
