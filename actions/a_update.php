...
<?php 
    ...
    if ($_POST) {
        ...
        $sql = "UPDATE media SET media_id = '$id', cover = '$cover', author_fname = '$fname', author_lname = '$lname', title = '$title', ISBN = '$isbn', short_description = '$description', type = '$type', availability = '$status' 
        WHERE media_id = '$id'";
